...
Here we look how proportion of direct breast cancer deaths (vs all deaths) changes as a function of age. I do the calculation twice: once for symptomatic patiens only, and then for all patients. Screened patiens don't show a simple linear decrease.
