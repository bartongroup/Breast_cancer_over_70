...
d71 <- sdat %>% 
  filter(Midage > 71) %>% 
  mutate(Outcome = recode(Outcome, "unrelated_bc_death" = "unrelated_death"), Age = "71+") %>% 
...
plot71(d71, what="count")
plot71(d71, what="proportion")
plot71(d71, what="proportion", pos="stack")
...
The unrelated death proportion is greater in the symptomatic patiens. The difference is statistically significant, $p = `r signif(ft$p.value, 2)`$.
