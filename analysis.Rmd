...
plotAgeComparison <- function(d, ages=c("71-75", "76-80", "81-85", "86+"), what="propotion") {
...
```{r plot_again}
plotOutcomeProportion(sdat, value = cases[[4]]$value, others = cases[[4]]$others, tit = cases[[4]]$name, err="ci") +
...
```{r alternative_71, fig.width=5, fig.height=4}
plotGroupAge(d71, what="proportion", x="Outcome", group="Diagnostic") + theme(axis.text.x = element_text(angle=45, hjust=1))
```
